...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section("Punchlist - Job Fixes Pro") {
                if purchases.isPro {
            ...
            Section("About") {
                Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/punchlist-app/privacy.html")!)
                Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/punchlist-app/terms.html")!)
                Text("Version 1.0")
